...
void to_json(Json::Value& j, const ApiResponse& o)
{
...
void from_json(const Json::Value& j, ApiResponse& o)
{
    if(j.isMember("code"))
    {
        o.m_Code = j["code"].asInt();
    ...
    if(j.isMember("message"))
    {
        o.m_Message = j["message"];
...
void ApiResponse::setCode(std::int32_t const value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
