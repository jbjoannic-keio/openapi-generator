...
public:
    ...
    void setUserStatus(std::int32_t const value);
    bool userStatusIsSet() const;
    void unsetUserStatus();

    friend  void to_json(Json::Value& j, const User& o);
    friend  void from_json(const Json::Value& j, User& o);
protected:
    std::int64_t m_Id;
    bool m_IdIsSet;
