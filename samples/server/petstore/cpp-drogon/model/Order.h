...
public:
    ...
    void setPetId(std::int64_t const value);
    ...
    void setQuantity(std::int32_t const value);
    ...
    friend  void to_json(Json::Value& j, const Order& o);
    friend  void from_json(const Json::Value& j, Order& o);
protected:
    std::int64_t m_Id;
    bool m_IdIsSet;
    std::int64_t m_PetId;
